  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative h-full w-full bg-neutral-900">
      ...
      <main className="text-[#453847] w-full sm:w-[90%] md:w-[80%] lg:w-[640px] m-auto my-8 bg-[#eae9eb] flex flex-col gap-4 rounded-lg py-6 px-4 sm:px-6 md:px-8 relative z-10 max-w-[90vw]  max-h-[90vh]">
        ...
        {quizFinished ? (
          <>
            <h2 className="text-center text-2xl sm:text-3xl text-[#453847] font-nunito-regular font-extrabold">
              {score >= 5 ? "Congratulations, You Won!" : "You Lose!"}
            </h2>
            <button
              className="border-2 font-nunito-regular bg-[#453847] text-[#eae9eb] px-4 py-2 text-lg sm:w-1/2 md:w-1/4 rounded-md hover:scale-105 transition-transform mx-auto mt-5"
              onClick={restartQuiz} >
              Restart Quiz
            </button>
          </>
          ...
          <>
            <div className="flex flex-col items-start text-sm sm:text-base md:text-lg">
              ...
              <ul className="list-decimal w-[80%] sm:w-[90%] ml-5 font-nunito-regular font-semibold text-xs sm:text-sm md:text-base">
                <li
                  ref={Opt1}
                  onClick={(e) => {
                    checkAns(e, 1);
            ...
            <div className="font-nunito-regular flex items-center flex-col gap-2">
              <button
                className="border-2 font-semibold bg-[#453847] text-[#eae9eb] px-4 py-2 text-lg sm:w-1/2 md:w-1/4 rounded-md hover:scale-105 transition-transform"
